...
LOCAL_SRC_FILES := $(LIBRARY_PATH)/libjpeg.a
...
include $(CLEAR_VARS)
LOCAL_MODULE := libpng
LOCAL_SRC_FILES := $(LIBRARY_PATH)/libpng.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_SRC_FILES += $(SOURCE_PATH)/apiobjects/apiobject.cpp
...
LOCAL_SRC_FILES += $(SOURCE_PATH)/apiobjects/texturecache.cpp
LOCAL_SRC_FILES += $(SOURCE_PATH)/apiobjects/texturedata.cpp
