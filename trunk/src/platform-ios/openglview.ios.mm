...
- (void)createFramebuffer
{
	...
	if (_multisampled)
	{
		 ...
		 * Create color buffer
		 */
		glBindRenderbuffer(GL_RENDERBUFFER, _multisampledFramebuffer->colorRenderbuffer());
		 ...
		 * Create depth buffer
		 */
		glBindRenderbuffer(GL_RENDERBUFFER, _multisampledFramebuffer->depthRenderbuffer());
