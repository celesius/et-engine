...
#else
		LibHandle = dlopen("libGL.so", RTLD_LAZY | RTLD_LOCAL);
#endif
...
#ifndef _WIN32
		// GLX_VERSION_1_3
		glXGetFBConfigs = (PFNGLXGETFBCONFIGSPROC) glgGetProcAddress("glXGetFBConfigs");
		glXChooseFBConfig = (PFNGLXCHOOSEFBCONFIGPROC) glgGetProcAddress("glXChooseFBConfig");
		glXGetFBConfigAttrib = (PFNGLXGETFBCONFIGATTRIBPROC) glgGetProcAddress("glXGetFBConfigAttrib");
		glXGetVisualFromFBConfig = (PFNGLXGETVISUALFROMFBCONFIGPROC) glgGetProcAddress("glXGetVisualFromFBConfig");
		glXCreateWindow = (PFNGLXCREATEWINDOWPROC) glgGetProcAddress("glXCreateWindow");
		glXDestroyWindow = (PFNGLXDESTROYWINDOWPROC) glgGetProcAddress("glXDestroyWindow");
		glXCreatePixmap = (PFNGLXCREATEPIXMAPPROC) glgGetProcAddress("glXCreatePixmap");
		glXDestroyPixmap = (PFNGLXDESTROYPIXMAPPROC) glgGetProcAddress("glXDestroyPixmap");
		glXCreatePbuffer = (PFNGLXCREATEPBUFFERPROC) glgGetProcAddress("glXCreatePbuffer");
		glXDestroyPbuffer = (PFNGLXDESTROYPBUFFERPROC) glgGetProcAddress("glXDestroyPbuffer");
		glXQueryDrawable = (PFNGLXQUERYDRAWABLEPROC) glgGetProcAddress("glXQueryDrawable");
		glXCreateNewContext = (PFNGLXCREATENEWCONTEXTPROC) glgGetProcAddress("glXCreateNewContext");
		glXMakeContextCurrent = (PFNGLXMAKECONTEXTCURRENTPROC) glgGetProcAddress("glXMakeContextCurrent");
		glXGetCurrentReadDrawable = (PFNGLXGETCURRENTREADDRAWABLEPROC) glgGetProcAddress("glXGetCurrentReadDrawable");
		glXGetCurrentDisplay = (PFNGLXGETCURRENTDISPLAYPROC) glgGetProcAddress("glXGetCurrentDisplay");
		glXQueryContext = (PFNGLXQUERYCONTEXTPROC) glgGetProcAddress("glXQueryContext");
		glXSelectEvent = (PFNGLXSELECTEVENTPROC) glgGetProcAddress("glXSelectEvent");
		glXGetSelectedEvent = (PFNGLXGETSELECTEDEVENTPROC) glgGetProcAddress("glXGetSelectedEvent");

		// GLX_ARB_create_context
		glXCreateContextAttribsARB = (PFNGLXCREATECONTEXTATTRIBSARBPROC) glgGetProcAddress("glXCreateContextAttribsARB");

		// GLX_SGI_swap_control
		glXSwapIntervalSGI = (PFNGLXSWAPINTERVALSGIPROC) glgGetProcAddress("glXSwapIntervalSGI");

		// GLX_SGI_video_sync
		glXGetVideoSyncSGI = (PFNGLXGETVIDEOSYNCSGIPROC) glgGetProcAddress("glXGetVideoSyncSGI");
		glXWaitVideoSyncSGI = (PFNGLXWAITVIDEOSYNCSGIPROC) glgGetProcAddress("glXWaitVideoSyncSGI");

		// GLX_SGI_make_current_read
		glXMakeCurrentReadSGI = (PFNGLXMAKECURRENTREADSGIPROC) glgGetProcAddress("glXMakeCurrentReadSGI");
		glXGetCurrentReadDrawableSGI = (PFNGLXGETCURRENTREADDRAWABLESGIPROC) glgGetProcAddress("glXGetCurrentReadDrawableSGI");

		// GLX_EXT_import_context
		glXGetCurrentDisplayEXT = (PFNGLXGETCURRENTDISPLAYEXTPROC) glgGetProcAddress("glXGetCurrentDisplayEXT");
		glXQueryContextInfoEXT = (PFNGLXQUERYCONTEXTINFOEXTPROC) glgGetProcAddress("glXQueryContextInfoEXT");
		glXGetContextIDEXT = (PFNGLXGETCONTEXTIDEXTPROC) glgGetProcAddress("glXGetContextIDEXT");
		glXImportContextEXT = (PFNGLXIMPORTCONTEXTEXTPROC) glgGetProcAddress("glXImportContextEXT");
		glXFreeContextEXT = (PFNGLXFREECONTEXTEXTPROC) glgGetProcAddress("glXFreeContextEXT");

		// GLX_SGIX_fbconfig
		glXGetFBConfigAttribSGIX = (PFNGLXGETFBCONFIGATTRIBSGIXPROC) glgGetProcAddress("glXGetFBConfigAttribSGIX");
		glXChooseFBConfigSGIX = (PFNGLXCHOOSEFBCONFIGSGIXPROC) glgGetProcAddress("glXChooseFBConfigSGIX");
		glXCreateGLXPixmapWithConfigSGIX = (PFNGLXCREATEGLXPIXMAPWITHCONFIGSGIXPROC) glgGetProcAddress("glXCreateGLXPixmapWithConfigSGIX");
		glXCreateContextWithConfigSGIX = (PFNGLXCREATECONTEXTWITHCONFIGSGIXPROC) glgGetProcAddress("glXCreateContextWithConfigSGIX");
		glXGetVisualFromFBConfigSGIX = (PFNGLXGETVISUALFROMFBCONFIGSGIXPROC) glgGetProcAddress("glXGetVisualFromFBConfigSGIX");
		glXGetFBConfigFromVisualSGIX = (PFNGLXGETFBCONFIGFROMVISUALSGIXPROC) glgGetProcAddress("glXGetFBConfigFromVisualSGIX");

		// GLX_SGIX_pbuffer
		glXCreateGLXPbufferSGIX = (PFNGLXCREATEGLXPBUFFERSGIXPROC) glgGetProcAddress("glXCreateGLXPbufferSGIX");
		glXDestroyGLXPbufferSGIX = (PFNGLXDESTROYGLXPBUFFERSGIXPROC) glgGetProcAddress("glXDestroyGLXPbufferSGIX");
		glXQueryGLXPbufferSGIX = (PFNGLXQUERYGLXPBUFFERSGIXPROC) glgGetProcAddress("glXQueryGLXPbufferSGIX");
		glXSelectEventSGIX = (PFNGLXSELECTEVENTSGIXPROC) glgGetProcAddress("glXSelectEventSGIX");
		glXGetSelectedEventSGIX = (PFNGLXGETSELECTEDEVENTSGIXPROC) glgGetProcAddress("glXGetSelectedEventSGIX");

		// GLX_SGI_cushion
		glXCushionSGI = (PFNGLXCUSHIONSGIPROC) glgGetProcAddress("glXCushionSGI");

		// GLX_SGIX_video_resize
		glXBindChannelToWindowSGIX = (PFNGLXBINDCHANNELTOWINDOWSGIXPROC) glgGetProcAddress("glXBindChannelToWindowSGIX");
		glXChannelRectSGIX = (PFNGLXCHANNELRECTSGIXPROC) glgGetProcAddress("glXChannelRectSGIX");
		glXQueryChannelRectSGIX = (PFNGLXQUERYCHANNELRECTSGIXPROC) glgGetProcAddress("glXQueryChannelRectSGIX");
		glXQueryChannelDeltasSGIX = (PFNGLXQUERYCHANNELDELTASSGIXPROC) glgGetProcAddress("glXQueryChannelDeltasSGIX");
		glXChannelRectSyncSGIX = (PFNGLXCHANNELRECTSYNCSGIXPROC) glgGetProcAddress("glXChannelRectSyncSGIX");

		// GLX_SGIX_swap_group
		glXJoinSwapGroupSGIX = (PFNGLXJOINSWAPGROUPSGIXPROC) glgGetProcAddress("glXJoinSwapGroupSGIX");

		// GLX_SGIX_swap_barrier
		glXBindSwapBarrierSGIX = (PFNGLXBINDSWAPBARRIERSGIXPROC) glgGetProcAddress("glXBindSwapBarrierSGIX");
		glXQueryMaxSwapBarriersSGIX = (PFNGLXQUERYMAXSWAPBARRIERSSGIXPROC) glgGetProcAddress("glXQueryMaxSwapBarriersSGIX");

		// GLX_SUN_get_transparent_index
		glXGetTransparentIndexSUN = (PFNGLXGETTRANSPARENTINDEXSUNPROC) glgGetProcAddress("glXGetTransparentIndexSUN");

		// GLX_MESA_copy_sub_buffer
		glXCopySubBufferMESA = (PFNGLXCOPYSUBBUFFERMESAPROC) glgGetProcAddress("glXCopySubBufferMESA");

		// GLX_MESA_pixmap_colormap
		glXCreateGLXPixmapMESA = (PFNGLXCREATEGLXPIXMAPMESAPROC) glgGetProcAddress("glXCreateGLXPixmapMESA");

		// GLX_MESA_release_buffers
		glXReleaseBuffersMESA = (PFNGLXRELEASEBUFFERSMESAPROC) glgGetProcAddress("glXReleaseBuffersMESA");

		// GLX_MESA_set_3dfx_mode
		glXSet3DfxModeMESA = (PFNGLXSET3DFXMODEMESAPROC) glgGetProcAddress("glXSet3DfxModeMESA");

		// GLX_OML_sync_control
		glXGetSyncValuesOML = (PFNGLXGETSYNCVALUESOMLPROC) glgGetProcAddress("glXGetSyncValuesOML");
		glXGetMscRateOML = (PFNGLXGETMSCRATEOMLPROC) glgGetProcAddress("glXGetMscRateOML");
		glXSwapBuffersMscOML = (PFNGLXSWAPBUFFERSMSCOMLPROC) glgGetProcAddress("glXSwapBuffersMscOML");
		glXWaitForMscOML = (PFNGLXWAITFORMSCOMLPROC) glgGetProcAddress("glXWaitForMscOML");
		glXWaitForSbcOML = (PFNGLXWAITFORSBCOMLPROC) glgGetProcAddress("glXWaitForSbcOML");

		// GLX_SGIX_hyperpipe
		glXQueryHyperpipeNetworkSGIX = (PFNGLXQUERYHYPERPIPENETWORKSGIXPROC) glgGetProcAddress("glXQueryHyperpipeNetworkSGIX");
		glXHyperpipeConfigSGIX = (PFNGLXHYPERPIPECONFIGSGIXPROC) glgGetProcAddress("glXHyperpipeConfigSGIX");
		glXQueryHyperpipeConfigSGIX = (PFNGLXQUERYHYPERPIPECONFIGSGIXPROC) glgGetProcAddress("glXQueryHyperpipeConfigSGIX");
		glXDestroyHyperpipeConfigSGIX = (PFNGLXDESTROYHYPERPIPECONFIGSGIXPROC) glgGetProcAddress("glXDestroyHyperpipeConfigSGIX");
		glXBindHyperpipeSGIX = (PFNGLXBINDHYPERPIPESGIXPROC) glgGetProcAddress("glXBindHyperpipeSGIX");
		glXQueryHyperpipeBestAttribSGIX = (PFNGLXQUERYHYPERPIPEBESTATTRIBSGIXPROC) glgGetProcAddress("glXQueryHyperpipeBestAttribSGIX");
		glXHyperpipeAttribSGIX = (PFNGLXHYPERPIPEATTRIBSGIXPROC) glgGetProcAddress("glXHyperpipeAttribSGIX");
		glXQueryHyperpipeAttribSGIX = (PFNGLXQUERYHYPERPIPEATTRIBSGIXPROC) glgGetProcAddress("glXQueryHyperpipeAttribSGIX");

		// GLX_MESA_agp_offset
		glXGetAGPOffsetMESA = (PFNGLXGETAGPOFFSETMESAPROC) glgGetProcAddress("glXGetAGPOffsetMESA");

		// GLX_EXT_texture_from_pixmap
		glXBindTexImageEXT = (PFNGLXBINDTEXIMAGEEXTPROC) glgGetProcAddress("glXBindTexImageEXT");
		glXReleaseTexImageEXT = (PFNGLXRELEASETEXIMAGEEXTPROC) glgGetProcAddress("glXReleaseTexImageEXT");

		// GLX_NV_present_video
		glXEnumerateVideoDevicesNV = (PFNGLXENUMERATEVIDEODEVICESNVPROC) glgGetProcAddress("glXEnumerateVideoDevicesNV");
		glXBindVideoDeviceNV = (PFNGLXBINDVIDEODEVICENVPROC) glgGetProcAddress("glXBindVideoDeviceNV");

		// GLX_NV_video_output
		glXGetVideoDeviceNV = (PFNGLXGETVIDEODEVICENVPROC) glgGetProcAddress("glXGetVideoDeviceNV");
		glXReleaseVideoDeviceNV = (PFNGLXRELEASEVIDEODEVICENVPROC) glgGetProcAddress("glXReleaseVideoDeviceNV");
		glXBindVideoImageNV = (PFNGLXBINDVIDEOIMAGENVPROC) glgGetProcAddress("glXBindVideoImageNV");
		glXReleaseVideoImageNV = (PFNGLXRELEASEVIDEOIMAGENVPROC) glgGetProcAddress("glXReleaseVideoImageNV");
		glXSendPbufferToVideoNV = (PFNGLXSENDPBUFFERTOVIDEONVPROC) glgGetProcAddress("glXSendPbufferToVideoNV");
		glXGetVideoInfoNV = (PFNGLXGETVIDEOINFONVPROC) glgGetProcAddress("glXGetVideoInfoNV");

		// GLX_NV_swap_group
		glXJoinSwapGroupNV = (PFNGLXJOINSWAPGROUPNVPROC) glgGetProcAddress("glXJoinSwapGroupNV");
		glXBindSwapBarrierNV = (PFNGLXBINDSWAPBARRIERNVPROC) glgGetProcAddress("glXBindSwapBarrierNV");
		glXQuerySwapGroupNV = (PFNGLXQUERYSWAPGROUPNVPROC) glgGetProcAddress("glXQuerySwapGroupNV");
		glXQueryMaxSwapGroupsNV = (PFNGLXQUERYMAXSWAPGROUPSNVPROC) glgGetProcAddress("glXQueryMaxSwapGroupsNV");
		glXQueryFrameCountNV = (PFNGLXQUERYFRAMECOUNTNVPROC) glgGetProcAddress("glXQueryFrameCountNV");
		glXResetFrameCountNV = (PFNGLXRESETFRAMECOUNTNVPROC) glgGetProcAddress("glXResetFrameCountNV");

		// GLX_NV_video_capture
		glXBindVideoCaptureDeviceNV = (PFNGLXBINDVIDEOCAPTUREDEVICENVPROC) glgGetProcAddress("glXBindVideoCaptureDeviceNV");
		glXEnumerateVideoCaptureDevicesNV = (PFNGLXENUMERATEVIDEOCAPTUREDEVICESNVPROC) glgGetProcAddress("glXEnumerateVideoCaptureDevicesNV");
		glXLockVideoCaptureDeviceNV = (PFNGLXLOCKVIDEOCAPTUREDEVICENVPROC) glgGetProcAddress("glXLockVideoCaptureDeviceNV");
		glXQueryVideoCaptureDeviceNV = (PFNGLXQUERYVIDEOCAPTUREDEVICENVPROC) glgGetProcAddress("glXQueryVideoCaptureDeviceNV");
		glXReleaseVideoCaptureDeviceNV = (PFNGLXRELEASEVIDEOCAPTUREDEVICENVPROC) glgGetProcAddress("glXReleaseVideoCaptureDeviceNV");

		// GLX_NV_copy_image
		glXCopyImageSubDataNV = (PFNGLXCOPYIMAGESUBDATANVPROC) glgGetProcAddress("glXCopyImageSubDataNV");
#endif
	}
